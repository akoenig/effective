 ...
 * behavior, including storage path, header exclusions, and redaction effects.
 *
 * @since 1.0.0
 */
import type { Config } from 'effect'
import { Schema } from 'effect'
import type { RedactionEffect } from '../Types/RedactionEffect.js'
...
export class HttpRecorderConfig extends Schema.Class<HttpRecorderConfig>(
  ...
  /**
   * Optional redaction effect to modify request/response data before recording.
   * This effect receives context about the HTTP interaction and can return
   * modified headers and body data to mask sensitive information.
   */
  redaction: Schema.optional(Schema.Unknown as Schema.Schema<RedactionEffect>),
  /**
