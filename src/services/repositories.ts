...
import { GitHubRepository, RepositoryListOptions } from '../domain/repository.js';
    ...
    effect: Effect.gen(function* () {
      ...
      > =>
        Effect.gen(function* () {
          ...
          const encodedOptions = yield* Schema.encode(RepositoryListOptions)(options);
          ...
          const repositories = yield* Schema.decodeUnknown(Schema.Array(GitHubRepository))(rawRepositories);
      ...
      > =>
        Effect.gen(function* () {
          ...
          const rawRepositories = yield* httpClient.get<unknown[]>(`/users/${username}/repos`, {
            headers: authHeaders,
            searchParams,
          });
      ...
      > =>
        Effect.gen(function* () {
          ...
          const rawRepositories = yield* httpClient.get<unknown[]>(`/orgs/${org}/repos`, {
            headers: authHeaders,
            searchParams,
          });
